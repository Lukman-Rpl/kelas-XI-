...
public class MainActivity extends AppCompatActivity {
    ...
    public void showAlert(String pesan){
        ...
        buatAlert.setTitle("PERHAIAN!");
        buatAlert.setMessage(pesan);
        buatAlert.show();
    }

    public void showAlertDialogButton(String pesan){
        ...
        showAlert.setPositiveButton("YA",new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                showToast("pesan sudah dihapus");
            }
        });
        showAlert.setNegativeButton("TIDAK",new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                showToast("pesan tidak dihapus");
            }
        });
    ...
    public void btnAlertDialogButton(View view) {
        showAlertDialogButton("YAKIN AKAN DIHAPUS?");
    }
}